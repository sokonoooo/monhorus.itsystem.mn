...
import 'package:monhorus_mobile/core/push/push_messaging.dart';
...
const AppUser _customer = AppUser(
...
void main() {
  ...
  setUp(() {
    ...
    container = ProviderContainer(
      overrides: <Override>[
        ...
        authRepositoryProvider.overrideWithValue(_StubAuthRepository(_customer)),
      ],
    );
  ...
  Future<void> signIn() async {
    await container
        ...
        .login(email: _customer.email, password: 'passcode');
  ...
  test('signing in registers this device', () async {
    ...
    expect(
      client.bodies.last,
      containsPair('token', 'fcm-token-1'),
    );
  });
