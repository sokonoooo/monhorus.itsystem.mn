...
| 30 | `apps/web/src/features/portal/PortalCharts.tsx` | 172-188 | `riskHeadline` | Four hardcoded band keys + four hardcoded sentences | The first sentence a customer reads. A renamed band still gets shipped wording; a configured spare band is invisible and the customer is told everything is normal | `riskLevelsInOrder(bands)` |
...
| 22 | `riskHeadline` | `web/.../PortalCharts.tsx` | 172 | 4 keys + 4 sentences | yes | `riskLevelsInOrder` | P1 |
